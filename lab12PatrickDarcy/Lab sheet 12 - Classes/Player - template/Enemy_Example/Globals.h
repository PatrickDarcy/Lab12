...
const int PLAYER_SIZE = 80;  // default size of player rectangle width and height

const float SCREEN_WIDTH = 800.0f;   // the size of the screen in pixels used in the game
